...
<template>
  <div class="mt-16 flex w-full flex-col gap-4">
    <div
      class="flex h-96 w-full flex-col items-center justify-center gap-10 bg-gray-700 bg-[url(/homepageBG.jpg)] bg-cover bg-fixed bg-no-repeat object-fill text-center bg-blend-multiply select-none"
    >
